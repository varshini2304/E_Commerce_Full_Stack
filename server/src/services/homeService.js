...
export const getHomePageData = async () => {
  const [heroBanner, promoBanner, categories, featuredProducts, trendingProducts] =
    await Promise.all([
      Banner.findOne({ type: "hero", isActive: true }).lean(),
      Banner.findOne({ type: "promo", isActive: true }).lean(),
  ...
  return {
    ...
    hero: {
      ...
      subtitle: "Discover exclusive offers and best-selling products.",
    ...
    promoBanner: {
      ...
      description: "Limited-time promo from our curated collection.",
    ...
    promoBanners: promoBanner ? [promoBanner] : [],
  };
};
